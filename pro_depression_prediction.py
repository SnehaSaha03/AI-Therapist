...
save_directory ="Path of the joblib file" # Replace with the actual path
...
if st.button('Predict Depression'):
    ...
    if result == 'Depressed':
        ...
        if sender_email and sender_password and recipient_email:
            ...
            st.error("Email credentials not found. Please set SENDER_EMAIL, SENDER_PASSWORD, and RECIPIENT_EMAIL environment variables.")
